...
public interface SaleDetailRepository extends JpaRepository<SaleDetail, Long> {
        ...
        /**
         * Obtiene los productos más vendidos (solo ventas completadas).
         */
        @Query("""
        ...
        /**
         * Obtiene los productos más vendidos en un rango de fechas (solo ventas
         * completadas).
         */
        @Query("""
                        SELECT d.producto.id,
        ...
        /**
         * Suma total de unidades vendidas de un producto (solo ventas completadas).
         */
        @Query("""
