...
public interface CreditRepository extends JpaRepository<Credit, Long> {
         ...
         */
        List<Credit> findByEstadoOrderByFechaCreacionDesc();
         ...
         */
        @Query("SELECT COALESCE(SUM(c.montoPendiente), 0) FROM Credit c " +
                        "WHERE c.cliente.id = :clienteId AND c.estado = 'ACTIVO'")
